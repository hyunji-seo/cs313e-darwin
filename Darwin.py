				...
				for row in self.grid[0][0]:
					for c in row:
						try:
							...
							if m[0][0] == "infect":
								if creature.direction == "north" and self.grid[creature.x_cor-1][creature.y_cor] != '.' and self.grid[creature.x_cor-1][creature.y_cor] != species.c_id :
							   		self.grid[creature.x_cor-1][creature.y_cor] = creature.species.c_id
...
s.turn(turn, [[food, f1, food.instructions, f1.direction, f1.program_counter], 
	...
	[rover, r1, rover.instructions, r1.direction, r1.program_counter]])
